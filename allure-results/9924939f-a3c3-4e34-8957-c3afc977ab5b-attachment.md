...
- generic [ref=e3]:
  - generic [ref=e4]:
    ...
    - generic [ref=e53]:
      - generic [ref=e54]:
        - figure [ref=e55]
        - generic [ref=e56]: Joseph, You have $3,195.82 out of $3,433.53 to redeem for this transaction.
        - generic [ref=e58]: 
      - text: 
    - generic [ref=e61]:
      - generic [ref=e62]:
        ...
        - generic [ref=e74]:
          ...
          - generic [ref=e80]:
            ...
            - generic [ref=e154] [cursor=pointer]:
              - generic [ref=e155]:
                - checkbox "Hello hereby authorize the charging of my LnW card 512 500002 for the total amount of $237.71." [checked] [active] [ref=e156]
                - generic:
                  - img
              - generic [ref=e158]:
...
> 153 |         await this.page.waitForTimeout(2000)
      |                    ^ TypeError: Cannot read properties of undefined (reading 'page')
  154 |        await address.onclickconfirmcheckout()
  155 |        await expect(this.page.locator(this.pinheader)).toHaveText('Verify your PIN')
  156 | 
  157 |        await expect(this.page.locator(this.pinverify)).toHaveText('PIN Verified! Click Checkout to Proceed.')
  158 | 
  159 |        await address.onclickfinalcheckout()
  160 |        await page.waitForTimeout(8000)
  161 |     })
  162 | 
  163 | 
  164 | 
