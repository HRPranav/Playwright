...
Call log:
  - waiting for locator('//div[@class=\'sortDropdown\']/span[2]')
    - locator resolved to <span class="icon-caret" _ngcontent-kur-c90=""></span>
...
- generic [ref=e3]:
  - generic [ref=e4]:
    ...
    - generic [ref=e38]:
      - generic [ref=e39]:
        - figure [ref=e40]
        - generic [ref=e41]: Joseph, You have $ 6,922 out of $ 7,022 to redeem for this transaction.
        - generic [ref=e43]: 
      - text: 
    - generic [ref=e46]:
      - list [ref=e47]:
...
```ts
  ...
  66 | 
> 67 |         await this.page.locator(this.sorticon).selectOption('Price High to Low')
     |                                                ^ Error: locator.selectOption: Error: Element is not a <select> element
  68 |     }
  69 | 
  70 | 
