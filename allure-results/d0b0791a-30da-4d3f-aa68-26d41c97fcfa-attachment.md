        ...
        - generic [ref=e12]:
          ...
          - generic [ref=e14]:
            ...
            - generic [ref=e15]:
              ...
              - textbox [active] [ref=e21]: PBfbqah3zTAF
            - generic [ref=e22]:
              - generic [ref=e23]: 
              - generic [ref=e24]:
...
> 12 | test.beforeAll(async({browser})=>{
  ...
  52 |     await page.getByRole('button', { name: 'Select' }).first().click();
  53 |     await page.waitForTimeout(2000)
  54 |     await page.getByRole('button', { name: 'Yes' }).click();
  55 |    // await item.addcartlogobutton()
  56 |     
  57 | })
```