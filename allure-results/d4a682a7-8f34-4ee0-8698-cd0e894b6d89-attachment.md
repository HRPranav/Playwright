...
```
TypeError: i.textcontent is not a function
```
...
- generic [ref=e3]:
  - generic [ref=e4]:
    ...
    - generic [ref=e38]:
      - generic [ref=e39]:
        - figure [ref=e40]
        - generic [ref=e41]: Joseph, You have $ 6,950 out of $ 7,022 to redeem for this transaction.
        - generic [ref=e43]: 
      - text: 
    - generic [ref=e46]:
      - list [ref=e47]:
...
```ts
  ...
  62 | 
  63 |     for(const i of total){
  64 |        
  65 |         console.log(i.textContent())
> 66 |         const z=await i.textcontent()
     |                         ^ TypeError: i.textcontent is not a function
  67 | 
  68 |         if(z.includes('Price High to Low'))
  69 |         {
  70 |             await i.click()
  71 |             await page.waitForTimeout(10000)
  72 |         }
  73 |     }
  74 | 
  75 | })
