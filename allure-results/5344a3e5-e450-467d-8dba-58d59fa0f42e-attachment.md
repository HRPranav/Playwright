        ...
        - generic [ref=e12]:
          ...
          - generic [ref=e14]:
            ...
            - generic [ref=e24]:
              - generic [ref=e25]: PIN *
              - generic [ref=e29]:
                - textbox [ref=e30]: "1285"
                - generic [ref=e31]: 
            - button "Sign In" [active] [ref=e33] [cursor=pointer]
      - paragraph [ref=e34]: © 2026 2024 Light & Wonder, Inc. and its Subsidiaries. All rights reserved.
  - text: 
  - generic [ref=e35]:
    - generic:
      - img
...
> 9  | test.beforeAll(async ({browser}) => {
  ...
  57 | 
  58 |         if(r.includes("Lipton Peach Iced Tea, 16.9 Fl Oz Bottles (Pack of 12) ")){
  59 |            await m.click()
