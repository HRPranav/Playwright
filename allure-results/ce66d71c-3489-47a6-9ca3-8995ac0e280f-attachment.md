...
```ts
  ...
  9  |         this.clothesshoes='.categoryList-itemWrap > :nth-child(1) > figure > img'
  10 |         this.lifestyle='.categoryList-itemWrap > :nth-child(1) > figure > img'
  11 |         this.sportsroutdoors='.categoryList-itemWrap > :nth-child(1) > figure > img'
  12 | 
