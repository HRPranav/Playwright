...
- Name: Apitesting.spec.js >> Delete call
- Location: tests\Apitesting.spec.js:67:6
...
```ts
  ...
  41 | 
  42 | 
  43 | test("put call",async ({request})=>{
  44 | 
  ...
  46 | 
  47 | 
  48 |   const response=  await request.put('https://dummy.restapiexample.com/api/v1/update/1156',{
  49 |     data: {
  50 |       "name":"new",
  51 |       "salary":"10000",
  52 |       "age":"25"
  ...
  65 | 
  66 | 
  67 | test.only("Delete call",async ({request})=>{
  68 | 
  69 |   const token='eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..f0H87QK4d_FJUBLQxxb2b4gVew7d5krvEDilPZ2a-jM'
  70 | 
  71 | 
  72 |   const response=  await request.delete('https://dummy.restapiexample.com/api/v1/delete/1156')
  73 |   
  74 | 
  75 |   // Headers:{
  ...
  78 |   // }
  79 |   
> 80 |   await expect(response.status()).toBe(204)
     |                                   ^ Error: expect(received).toBe(expected) // Object.is equality
  81 | 
  82 | })
```