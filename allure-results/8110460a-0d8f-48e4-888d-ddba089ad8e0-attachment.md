...
Call log:
  ...
  - waiting for locator('//span[@class=\'icon-search\']')
    14 × locator resolved to <span class="icon-search" _ngcontent-qnt-c68=""></span>
...
```ts
  ...
  32  |        {
> 33  |           await expect(page.locator("//span[@class='icon-search']")).toBeVisible()
      |                                                                      ^ Error: expect(locator).toBeVisible() failed
  34  |        }
  35  | 
  36  |        else{
  37  |         await expect.soft(page.locator("//div[@class='genericErrors']")).toHaveText('Patron ID Already Used.')
  38  |        }
  39  | 
  40  | 
  41  |      })
