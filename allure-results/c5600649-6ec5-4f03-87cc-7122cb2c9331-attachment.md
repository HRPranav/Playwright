...
- generic [ref=e3]:
  - generic [ref=e4]:
    ...
    - generic [ref=e41]:
      - generic [ref=e42]:
        - figure [ref=e43]
        - generic [ref=e44]: Joseph, You have $3,070.85 out of $3,433.53 to redeem for this transaction.
        - generic [ref=e46]: 
      - text: 
    - generic [ref=e49]:
      - list [ref=e50]:
...
> 69 |     await expect(page.locator('//footer[@class="filter-footer"]/button[1]')).tobeVisible()
     |                                                                              ^ TypeError: (0 , _test.expect)(...).tobeVisible is not a function
  70 |     await item.pricefilter1()
  71 |     await expect(page.locator('//footer[@class="filter-footer"]/button[1]')).tobeVisible()
  72 |     await item.pricefilter2()
  73 |     await expect(page.locator('//footer[@class="filter-footer"]/button[1]')).tobeVisible()
  74 |     await item.pricefilter3()
  75 |     await expect(page.locator('//footer[@class="filter-footer"]/button[1]')).tobeVisible()
  76 |     await item.pricefilter4()
  77 |     await expect(page.locator('//footer[@class="filter-footer"]/button[1]')).tobeVisible()
